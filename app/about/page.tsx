...
export default function AboutPage() {
  return (
    <div className="bg-white">
      {/* Hero Banner Section */}
      <section className="relative max-w-7xl mx-auto rounded-lg overflow-hidden min-h-[300px] md:min-h-[400px] lg:min-h-[363px] hidden md:block ">
        <Image
      ...
      <section className="relative py-10 md:py-14 lg:py-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="w-full h-full bg-[url('/images/about/image-about.png')] bg-cover bg-center"></div>
        </div>
